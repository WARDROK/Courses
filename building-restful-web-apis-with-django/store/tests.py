...
class ProductCreateTestCase(APITestCase):
    ...
    def test_create_product(self):
        ...
        if response.status_code != 201:
            print("\033[91m", response.data, "\033[0m")
...
class ProductUpdateTestCase(APITestCase):
    def test_update_product(self):
        ...
        response = self.client.patch(
            ...
            {"name": "New Product", "description": "Awesome Producnt", "price": 123.45},
            format="json",
        )
        ...
        self.assertEqual(updated.description, "Awesome Producnt")
        self.assertEqual(updated.price, 123.45)

    def test_upload_product_photo(self):
        product = Product.objects.first()
        orginal_photo = product.photo
        ...
        self.assertNotEqual(response.data["photo"], orginal_photo)
