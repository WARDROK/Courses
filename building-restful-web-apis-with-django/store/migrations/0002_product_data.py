...
def create_sample_product_data(apps, schema_editor):
    ...
    Product(
        name='Mineral Water Strawberry', description='Natural-flavored strawberry with an anti-oxidant kick.', price=1.00,
        photo='products/mineralwater-strawberry.jpg',
    ).save()
    Product(
        name='Mineral Water Raspberry', description='Flavoured with raspberry, loaded with anti-oxidants.', price=2.00,
        photo='products/mineralwater-raspberry.jpg',
    ).save()
    Product(
        name='Vitamin A 10,000 IU (125 caplets)', price=3.00,
    ...
    Product(
        name='Vitamin B-Complex (100 caplets)', price=3.00,
